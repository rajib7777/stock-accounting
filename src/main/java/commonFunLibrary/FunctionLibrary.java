...
public class FunctionLibrary {
	       ...
	       static WebDriver driver;
			...
			public static WebDriver startBrowser() throws Exception{
				...
				if(PropertyFileUtil.getValueFoeKey("Browser").equalsIgnoreCase("chrome")){
					System.setProperty("webdriver.chrome.driver", "D:\\RAJIB\\Selenium\\StockAccounting_Hybrid_mvn82\\drivers\\chromedriver.exe");
					 driver =new ChromeDriver();	
				}else if(PropertyFileUtil.getValueFoeKey("Browser").equalsIgnoreCase("firefox")){
			...
			public static void openApplication(WebDriver driver) throws Exception{
				driver.get(PropertyFileUtil.getValueFoeKey("Url"));	
			...
			public static void tableValidation(WebDriver driver,String column) throws Exception{
				...
				if(driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("searchtextbox"))).isDisplayed()){
					Thread.sleep(5000);
					driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("searchtextbox"))).sendKeys(Exp_data);
					driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("searchbutton"))).click();
				}else{
					driver.findElement(By.xpath(PropertyFileUtil.getValueFoeKey("searchpanelbutton"))).click();
					Thread.sleep(5000);
					driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("searchtextbox"))).sendKeys(Exp_data);
					driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("searchbutton"))).click();
				}
				
				WebElement table=driver.findElement(By.id(PropertyFileUtil.getValueFoeKey("suppliertable")));
			...
			public static void captureData(WebDriver driver,String locatortytpe,
				...
				FileWriter fw=new FileWriter ("D:\\RAJIB\\Selenium\\StockAccounting_Hybrid_mvn82\\CaptureData\\suppnumber.txt");
